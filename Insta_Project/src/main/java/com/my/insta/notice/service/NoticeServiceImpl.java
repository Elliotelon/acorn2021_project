...
import com.my.insta.notice.dao.NoticeCommentDao;
...
public class NoticeServiceImpl implements NoticeService{
	...
	public void getDetail(int num, ModelAndView mView) {
		...
		// NoticeCommentDto 객체에 위에서 계산된 startRowNum 과 endRowNum 을 담는다.
	...
	public void deleteComment(HttpServletRequest request) {
		...
		String writer=noticeCommentDao.getData(num).getWriter();
//		if(!writer.equals(id)) {
...
//			}
	...
	public void moreCommentList(HttpServletRequest request) {
		...
		NoticeDto dto=noticeDao.getData(ref_group);
		...
		//전체 row 의 갯수를 읽어온다.
		//자세히 보여줄 글의 번호가 ref_group  번호 이다. 
		int totalRow=noticeCommentDao.getCount(ref_group);
		//전체 페이지의 갯수 구하기
		int totalPageCount=
				(int)Math.ceil(totalRow/(double)PAGE_ROW_COUNT);
